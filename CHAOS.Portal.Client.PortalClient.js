...
function PortalServiceResult(data)
{
	...
	{
		_error = data.ModuleResults[0].Fullname + ": " + data.ModuleResults[0].Message;
		_error += "\nStacktrace: " + data.ModuleResults[0].Stacktrace;
	}
...
function PortalModuleResult(data)
{
	...
	{
		_error = data.Results[0].Fullname + ": " + data.Results[0].Message;
		_error += "\nStacktrace: " + data.Results[0].Stacktrace;
	}
	else
	{
